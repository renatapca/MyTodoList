  ...
  <q-page padding>
    ...
    bordered padding>
      ...
      <q-item tag="label" v-ripple>
        <q-item-section>
          <q-item-label>Mostrar formato de 12horas</q-item-label>
        </q-item-section>
        <q-item-section side>
          <q-toggle
          color="blue"
      ...
      <q-item tag="label" v-ripple>
        <q-item-section>
          <q-item-label>Mostrar tarefa em 1 lista</q-item-label>
        </q-item-section>
        <q-item-section side>
          <q-toggle
          color="blue"
      ...
      @click="visitOurWebsite"
       tag="label" v-ripple>
        <q-item-section>
          <q-item-label>Visite nosso website</q-item-label>
        </q-item-section>
        <q-item-section side>
        </q-item-section>
      </q-item>
...
export default {
  ...
  methods: {
    ...
    emailUs () {
      window.location.href = 'mailTo:renatapca@hotmaill.com?subject=todo list feedback'
    }
  }
}
</script>
